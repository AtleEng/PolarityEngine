...
namespace Polarity
{
	...
	public:
		...
		static void DrawQuad(const Ref<Texture2D>& texture, const glm::vec3& position, const glm::vec2& size = { 1.0f, 1.0f },  const glm::vec4& color = { 1.0f, 1.0f, 1.0f, 1.0f }, const float textureScale = 1.0f);
		static void DrawQuad(const Ref<Texture2D>& texture, const glm::vec2& position, const glm::vec2& size = { 1.0f, 1.0f },  const glm::vec4& color = { 1.0f, 1.0f, 1.0f, 1.0f }, const float textureScale = 1.0f);
